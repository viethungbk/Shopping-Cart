                    ...
                    <div className="products">
                        <div className="product">
                            ...
                            <div className="product-image">
                                <div className="image">
                                    <Link to="/product-details">
                                        <img src="/assets/images/products/samsung-note-9.jpg" alt={this.props.product.name} />
                            ...
                            <div className="product-info text-left">
                                <h3 className="name"><Link to="/product-details">{ this.props.product.name }</Link></h3>
                                ...
                                <div className="product-price">
                                    ...
                                    <span className="price-before-discount">
                                        $ {this.props.product.price_before_discount}
                                    </span>
                                </div>
                            </div>
