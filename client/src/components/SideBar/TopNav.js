  ...
  render() {
    ...
    return (
      <div className="side-menu animate-dropdown outer-bottom-xs">
        <div className="head"><i className="icon fa fa-align-justify fa-fw" /> Thể loại</div>
        <nav className="yamm megamenu-horizontal">
          <ul className="nav">
            <li className="dropdown menu-item">
              ...
              >
                <i className="icon fa fa-shopping-bag" aria-hidden="true" />SamSung
            </Link></li>
            <li className="dropdown menu-item">
              <Link to="" className="dropdown-toggle" data-toggle="dropdown"
            ...
            <li className="dropdown menu-item"> <Link to="" className="dropdown-toggle" data-toggle="dropdown"
